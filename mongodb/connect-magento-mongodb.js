...
var data = [{"sku":"BLGA3088-WH001","store_view_code":"","attribute_set_code":"Migration_Default",
...
MongoClient.connect(url, function(err, db) {
	console.log("Connecté à la base de données 'Magento'");
  	assert.equal(null, err);
  	let crud = new Crud();
  	crud.insertDocuments(db, "products", data , function(){
  		crud.findDocuments(db, "products", function(){
  			db.close();
  		});
  	});
});
